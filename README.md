...
A JavaScript function that translates a ROT13 encoded string.
...
As with all the other projects I've completed on this course, my code is still fairly basic. It's not too long but I'm sure it could be shortened to a few lines once I understand JavaScript a lot better. It works for now and should be easy to understand at least.

The original task just tested using uppercase but I've added in some code to translate from lowercase too.

At some point I'll add, into the HTML, some options of words and phrases in ROT13 to test with.

I think it'd be good to add a feature that works in reverse to this too, i.e. converting a regular phrase into ROT13. This is something I can do in future as well as refactoring my existing code.
